...
func ConnectDB(dbType, dsn string) {
	...
	if result.RowsAffected == 0 {
		versions := []*Version{
			...
			{Kubernetes: "v1.29.12", Etcd: "3.5.12-0", Containerd: "2.0.0", Runc: "1.2.1", Pause: "3.9", Coredns: "1.11.1", MetricsServer: "0.7.2", KubeStateMetrics: "2.12.0", Dashboard: "7.8.0"},
			{Kubernetes: "v1.30.8", Etcd: "3.5.12-0", Containerd: "2.0.0", Runc: "1.2.1", Pause: "3.9", Coredns: "1.11.1", MetricsServer: "0.7.2", KubeStateMetrics: "2.13.0", Dashboard: "7.8.0"},
			{Kubernetes: "v1.31.4", Etcd: "3.5.15-0", Containerd: "2.0.0", Runc: "1.2.1", Pause: "3.10", Coredns: "1.11.1", MetricsServer: "0.7.2", KubeStateMetrics: "2.13.0", Dashboard: "7.8.0"},
			{Kubernetes: "v1.32.0", Etcd: "3.5.16-0", Containerd: "2.0.0", Runc: "1.2.1", Pause: "3.10", Coredns: "1.11.3", MetricsServer: "0.7.2", KubeStateMetrics: "2.13.0", Dashboard: "7.8.0"},
		}
		db.Create(versions)
	}
}
