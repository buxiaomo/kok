...
func NewSealosCertMetaData(certPATH, certEtcdPATH string, apiServerIPAndDomains []string, nodeName, nodeIP, DNSDomain string) (*SealosCertMetaData, error) {
...
func (meta *SealosCertMetaData) generatorServiceAccountKeyPaire() error {
	...
	if !os.IsNotExist(err) {
		log.Printf("sa.key sa.pub already exist")
		return nil
	}
