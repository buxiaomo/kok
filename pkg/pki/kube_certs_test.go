...
func TestGenerateAll(t *testing.T) {
	...
	certMeta, err := NewSealosCertMetaData(BasePath, EtcdBasePath, []string{"test.com", "192.168.1.2", "kubernetes.default.svc.sealos"}, "master1", "172.27.139.11", "cluster.local")
	if err != nil {
		t.Error(err)
	}
